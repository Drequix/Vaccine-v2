...
import { formatDateString, formatTimeString } from "@/lib/utils/format-time"
...
interface MedicalAppointment {
  ...
  // Properties required by AttendAppointmentModal
...
export function MedicalAppointmentsView() {
  ...
  const loadAppointments = useCallback(async () => {
    ...
    try {
      const data = await fetchAppointments("/appointments/medical")
