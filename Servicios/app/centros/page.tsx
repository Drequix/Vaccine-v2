              ...
              <div className="bg-gray-100 dark:bg-gray-800 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                <div className="h-96 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Mapa Interactivo</h3>
                    <p className="text-gray-600 dark:text-gray-400">
                      Aquí se mostraría el mapa interactivo con la ubicación de todos los centros
                    </p>
                    <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
                      {filteredCentros.length} centros encontrados
                    </p>
                  </div>
                </div>
              </div>
